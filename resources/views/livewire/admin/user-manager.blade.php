<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
            <h1 class="text-xl font-bold text-stone-900">Admin-Benutzer</h1>
            <p class="text-sm text-stone-500 mt-0.5">Systemadministratoren verwalten</p>
        </div>
        <button
            type="button"
    ...
    <div class="mb-4">
        <input
            ...
            placeholder="Nach Name, E-Mail, Position, Rolle suchen…"
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="text-left text-xs font-bold text-stone-400 uppercase tracking-wider bg-stone-50 border-b border-stone-100">
                    ...
                    <th class="px-5 py-3 hidden lg:table-cell">Rolle</th>
                    <th class="px-5 py-3 hidden sm:table-cell">E-Mail</th>
            ...
            <tbody class="divide-y divide-stone-50">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center justify-end gap-1.5">
                            ...
                            <button
                                ...
                                wire:confirm="{{ $user->name }} löschen? Dies kann nicht rückgängig gemacht werden."
                ...
                <tr>
                    <td colspan="5" class="px-5 py-16 text-center">
                        <p class="text-sm font-semibold text-stone-400">Keine Benutzer gefunden</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
        ...
        <div class="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl flex flex-col">
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-stone-100">
                <h2 class="text-base font-bold text-stone-900">
                    {{ $editingId ? 'Benutzer bearbeiten' : 'Admin-Benutzer hinzufügen' }}
                </h2>
            ...
            <div class="flex-1 overflow-y-auto px-6 py-6 space-y-5">
                ...
                <div>
                    <label class="block text-xs font-bold text-stone-600 mb-1.5 uppercase tracking-wider">Systemrolle</label>
                    <select
                ...
                <div>
                    <label class="block text-xs font-bold text-stone-600 mb-1.5 uppercase tracking-wider">
                        Passwort
                        @if ($editingId)
                        <span class="font-normal text-stone-400 normal-case tracking-normal">(leer lassen, um das aktuelle zu behalten)</span>
                        @endif
                    </label>
                    <input
                        type="password"
                        wire:model="form_password"
                        placeholder="{{ $editingId ? '••••••••' : 'Mind. 8 Zeichen' }}"
            ...
            <div class="px-6 py-5 border-t border-stone-100 flex justify-end gap-3">
                ...
                >
                    <span wire:loading.remove wire:target="save">
                        {{ $editingId ? 'Änderungen speichern' : 'Benutzer erstellen' }}
                    </span>
